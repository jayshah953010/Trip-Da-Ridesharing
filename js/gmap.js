        ...
        if (status == google.maps.DirectionsStatus.OK) {
            ...
            $(directionsDiv).append(
                '<div class="btn-container">' +
                    '<a href="#" class="button" id="print" onclick="window.print();"><i class="icon-print icon-white"></i> Print</a>' +
                '</div>' +
                '<h4>Your Route :</h4>'
            );
...
function add_waypoint()
{
    ...
    waypoint_container+= '      &nbsp;<a href="#" onclick="return add_waypoint();" class="button2">Add Waypoints</a>';
    waypoint_container+= '      &nbsp;<a href="#" onclick="return remove_waypoint(this);" class="button2" id="remove">Remove</a>';
